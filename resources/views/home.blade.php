...
@section('content')
    ...
    >
        ...
        <header class="flex flex-wrap items-center justify-between gap-4 py-2 sm:gap-6">
            ...
            <nav class="flex items-center gap-2 sm:gap-3" aria-label="Account">
                <a
                    href="{{ route('login') }}"
        ...
        >
            ...
            <div
                class="mt-14 w-full max-w-lg sm:mt-16"
                aria-hidden="true"
            >
                <div
                ...
                >
                    <div class="mb-4 flex items-center gap-2">
                        ...
                        <span class="ml-auto font-mono text-[10px] tracking-wide text-zinc-400 uppercase">
                            preview.blade.php
                        </span>
                    </div>
                    <div
                    ...
                    >
                        <p class="font-mono text-[11px] leading-6 text-zinc-500 sm:text-xs sm:leading-7">
                            <span class="text-indigo-600">&lt;section</span>
                            <span class="text-zinc-700">&nbsp;class=</span><span class="text-emerald-700">"…"</span>
                            <span class="text-indigo-600">&gt;</span>
                        </p>
                        <p class="mt-1 ml-3 font-mono text-[11px] leading-6 text-zinc-500 sm:text-xs sm:leading-7">
                            <span class="text-indigo-600">&lt;h1&gt;</span><span class="text-zinc-800">Headline</span><span class="text-indigo-600">&lt;/h1&gt;</span>
                        </p>
                        <p class="mt-1 ml-3 font-mono text-[11px] leading-6 sm:text-xs sm:leading-7">
                            <span class="text-zinc-500">// quiet, intentional layout</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <p
                class="inline-flex mt-14 max-w-full items-center gap-x-2 rounded-full border border-zinc-200/90 bg-white/80 px-3 py-1 text-[10px] font-semibold tracking-[0.18em] text-zinc-500 uppercase shadow-sm backdrop-blur-sm sm:text-[11px]"
            >
